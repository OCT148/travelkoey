    ...
    <div class="container"> 
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                <li><a href="#" class="nav-link px-2 link-secondary">Kategori Tempat Wisata</a></li>
            ...
            <div>
                <a href="#" class="d-block link-dark text-decoration-none" id="userpfp" aria-expanded="false">
